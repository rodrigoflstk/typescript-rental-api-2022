...
- Não deve ser possível cadastrar uma ecategoria para um - carro não cadastrado.
...
- Deve ser possível listar todos as categorias disponíveis pelo - nome da categoria
